...
class LibrispeechDataset(BaseDataset):
    def __init__(self, part, data_dir=None, working_dir=None, *args, **kwargs):
        ...
        self._working_dir = Path(
            working_dir) if working_dir is not None else self._data_dir
        if part == 'train_all':
    ...
    def _get_or_load_index(self, part):
        index_path = self._working_dir / f"{part}_index.json"
